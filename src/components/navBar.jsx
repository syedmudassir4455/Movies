...
const NavBar = () => {
  return (
    <nav className="navbar d-flex flex-column bg-nav navbar-expand-lg navbar-expand-d-xl navbar-expand-sm  navbar-navbar-expand-md">
      <Link className="navbar-brand navbar-brand-a" to="/">
        Vidly
      </Link>
      <button className="navbar-toggler bg-warning" type="button" data-toggle="collapse" data-target="#navbarNavDropdown" aria-controls="navbarNavDropdown" aria-expanded="false" aria-label="Toggle navigation">
